...
class JpaIssuedCredentialStorageTest {
    ...
    private val supersessionService = mock(IssuedCredentialSupersessionService::class.java)
    ...
    private fun storage(repo: WalletCredentialRepository) = JpaIssuedCredentialStorage(
        repo,
